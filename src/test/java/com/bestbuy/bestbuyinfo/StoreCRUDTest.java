...
public class StoreCRUDTest extends TestBase {
    static String name ="White House"+TestUtils.getRandomValue();
    static String type ="Electric General";
    static String address="100,Dorset Street";
    static String address2="Midlands";
    static String city="Paddington"+TestUtils.getRandomValue();
    static String state="Herts";
    static String zip="W3 4TH";
